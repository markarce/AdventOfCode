...
def find_incomplete_line_middle_score(filename):
    ...
    for i in range(0, len(lines)):
        corrupt, brackets = is_corrupt(lines[i])
        if not corrupt:
            line = lines[i]
            score_list = []
            score = 0
            while brackets:
                ...
                closer = close_brackets[index]
                score_list.append(closer)
...
find_incomplete_line_middle_score("data.txt")