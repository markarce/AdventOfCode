...
def find_duplicated_assignment_pairs(filename):
    ...
    for line in lines:
        ...
        overlapping_assignments += int(set_1.issubset(set_2) or set_2.issubset(set_1))

    print(overlapping_assignments)

find_duplicated_assignment_pairs("data.txt")